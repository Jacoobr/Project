...
/**
 * 数据库工具类 -->>SQLiteOpenHelper
 * 					-->>1.创建数据库
 * 					-->>2.数据库更新
 */
 //A helper class be used to manage database creation and version management.
public class DBHelper extends SQLiteOpenHelper{
	...
	// 创建时调用SQLiteOpenHelper.onCreate()
